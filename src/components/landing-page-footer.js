        ...
        <div className="row">
            ...
            <div className="row no-padding">
                <div className="col-xs-12 col-sm-3 contact-support">
                    ...
                    <p className="contact-bar-text">Available 24 hours a day* Monday-Friday</p>
                </div>
                <div className="col-xs-12 col-sm-9 contact-details">
                            <div className="row no-padding">
                    <div className="col-xs-7 col-md-3">
                        <p className="contact-bar-text"><i className="fa fa-phone"></i> 1-844-700-DUTY</p>
                    </div>
                    <div className="col-xs-5 col-md-3">
                        <p className="contact-bar-text"><i className="fa fa-globe"></i> 1-415-805-7070</p>
                    </div>
                    <div className="col-xs-7 col-md-3">
                        <p className="contact-bar-text"><i className="fa fa-envelope-o"></i> <a href="mailto:support@pagerduty.com">
                        support@pagerduty.com</a>
                        </p>
                    </div>
                    <div className="col-xs-5 col-md-3">
                        <p className="contact-bar-text"><i className="fa fa-twitter"></i><a href="https://twitter.com/pagerdutyhelp">
                        @pagerdutyhelp</a></p>
                    </div>
                    </div>
                    </div>
